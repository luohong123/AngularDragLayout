...
let AppComponent = class AppComponent {
    constructor(renderer, injector, componentFactoryResolver, storeService, commonService, dom, modalService, shareService, message, cdr, aditemService) {
   ...
   */
     ...
     * @param parentNode
     */
    loadDynamicComponent(component, ref, data, renderer) {
...
let AntdtemplateModule = class AntdtemplateModule {
};
...
let GridComponent = class GridComponent {
    constructor(cfResolver, vcRef, renderer, compiler, shareService) {
    ...
    createComponentModule(componentType) {
        const runtimeComponentModule = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
...
let AntdbuttonuiComponent = class AntdbuttonuiComponent {
};
...
Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["registerLocaleData"])(_angular_common_locales_zh__WEBPACK_IMPORTED_MODULE_2___default.a);
let AntduiModule = class AntduiModule {
};
...
class AdItemComponent {
    constructor(component, data) {
        this.component = component;
        this.data = data;
    }
}
AdItemComponent.ctorParameters = () => [
...
let DragbuttonComponent = class DragbuttonComponent {
};
...
let PreviewComponent = class PreviewComponent {
    constructor(renderer, compiler, sanitizer, resolver) {
        this.renderer = renderer;
        this.compiler = compiler;
    ...
    createTemplate(template, bindings) {
        let dynamicComponent = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
let DragnameDirective = class DragnameDirective {
    constructor() {
    }
    onDragStart(event) {
...
let AditemService = class AditemService {
    getAds() {
        return [
...
let DragService = class DragService {
     ...
     * @param event
     */
    dragstart_handler(event, handlerName) {
